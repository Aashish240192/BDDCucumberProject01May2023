...
public class StepDefinition extends Base {
	...
	public void user_lanch_chrome_browser() {
		...
		ad = new Admin(driver);// create object of AdminPage JAva class
	}
	...
	public void tearDown(Scenario sc) {
		...
		if(sc.isFailed()==true) {
			...
			String fileWithPath="C:\\Users\\ADMIN\\eclipse-workspace\\Mavenproject16Batch2023\\Screenshot\\failedScreenshot.png";
